...
export default function Btn({ children, onClick, title, active, kind = "ghost", disabled, style }) {
  const base = {
    ...
    letterSpacing: ".04em", textTransform: "uppercase", fontFamily: "'Oswald', sans-serif",
  ...
  const kinds = {
    ...
    danger: { background: "rgba(178,58,46,.16)", borderColor: "rgba(178,58,46,.55)", color: "#e5988c" },
  };
  const act = active
    ? { background: T.accent, borderColor: T.accent, color: "#0f1207",
